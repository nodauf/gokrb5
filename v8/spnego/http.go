...
const (
	...
	sessionCredentials = "github.com/nodauf/gokrb5/v8/sessionCredentials"
	// ctxCredentials is the SPNEGO context key holding the credentials jcmturner/goidentity/Identity object.
	ctxCredentials = "github.com/nodauf/gokrb5/v8/ctxCredentials"
